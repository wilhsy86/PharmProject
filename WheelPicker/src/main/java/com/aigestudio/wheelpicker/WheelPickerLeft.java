 ...
 * @version 1.1.0
 */
public class WheelPickerLeft extends View implements IDebug, IWheelPickerLeft, Runnable {
    ...
    private static final String TAG = WheelPickerLeft.class.getSimpleName();
    ...
    public WheelPickerLeft(Context context) {
        this(context, null );
    }



    public WheelPickerLeft(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.WheelPicker);
        int idData = a.getResourceId(R.styleable.WheelPicker_wheel_data, 0);

//        if (location == "left"){
//            mData = Arrays.asList(getResources().getStringArray(idData == 0 ? R.array.WheelArrayGeneric : idData));
//        }
//        else if (location == "center"){
//            mData = Arrays.asList(getResources().getStringArray(idData == 0 ? R.array.WheelArrayThera : idData));
//        }
//        else if (location == "right"){
//            mData = Arrays.asList(getResources().getStringArray(idData == 0 ? R.array.WheelArrayPharma : idData));
//        }
    ...
    public interface OnItemSelectedListener {
         ...
         * @param position
         */
        void onItemSelected(WheelPickerLeft picker, Object data, int position);
    }
